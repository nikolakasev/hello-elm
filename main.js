	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'value',
					_1: _elm_lang$core$Json_Encode$string(record.value)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _nikolakasev$hello_elm$Model$encodeSensory = F3(
	function (event, forProcessId, withIngredients) {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'id',
					_1: _elm_lang$core$Json_Encode$string(forProcessId)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'name',
						_1: _elm_lang$core$Json_Encode$string(event)
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_0: 'ingredients',
							_1: _elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, _nikolakasev$hello_elm$Model$encodeIngredient, withIngredients))
						},
						_1: {ctor: '[]'}
					}
				}
...
var _nikolakasev$hello_elm$Api$processUrl = 'http://localhost:3000/process';
...
var _nikolakasev$hello_elm$Api$fetchProcesses = A3(_ohanhi$remotedata_http$RemoteData_Http$get, _nikolakasev$hello_elm$Api$fetchProcessesUrl, _nikolakasev$hello_elm$Messages$OnFetchProcesses, _nikolakasev$hello_elm$Model$processesDecoder);

var _nikolakasev$hello_elm$Main$extractDoubtAnswers = function (name) {
	return A2(
		_elm_lang$core$List$filter,
		function (s) {
			return _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$String$isEmpty(s),
				false);
		},
		A3(
			_elm_lang$core$Regex$split,
			_elm_lang$core$Regex$All,
			_elm_lang$core$Regex$regex('AnswerWith|Or'),
			name));
};
var _nikolakasev$hello_elm$Main$commandForDetails = function (processes) {
	return A2(
		...
		A2(
			...
			function (p) {
				return _nikolakasev$hello_elm$Api$fetchDetails(p.id);
			},
			_elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					function (p) {
						return _elm_lang$core$Native_Utils.eq(p.details, _elm_lang$core$Maybe$Nothing);
					},
					processes))));
};
var _nikolakasev$hello_elm$Main$enrichActionable = F2(
	function (details, processes) {
		return A2(
			_elm_lang$core$List$map,
			function (p) {
				return _elm_lang$core$Native_Utils.eq(details.id, p.id) ? _elm_lang$core$Native_Utils.update(
					p,
					{
						details: _elm_lang$core$Maybe$Just(details.ingredients)
					}) : p;
			},
			processes);
	});
...
var _nikolakasev$hello_elm$Main$noProcessesFound = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('No actionable processes found.'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
...
var _nikolakasev$hello_elm$Main$actionableCard = function (forProcess) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('col m4'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(forProcess.name),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
...
var _nikolakasev$hello_elm$Main$someProcess = {
	...
	details: _elm_lang$core$Maybe$Just(
		{
			ctor: '::',
