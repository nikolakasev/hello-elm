...
var _nikolakasev$hello_elm$Model$encodeList = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
			...
			_1: {
				...
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _nikolakasev$hello_elm$Model$encodeIngredient, record.ingredients))
				},
				_1: {ctor: '[]'}
			}
		});
...
var _nikolakasev$hello_elm$Repl$d_e_l_t_r_o_n_3_0_3_0 = _nikolakasev$hello_elm$Main$extractDoubtAnswers('AnswerWithJaOrNee');
