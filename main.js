...
var _nikolakasev$hello_elm$Repl$r = {name: 'hello', value: 'there'};
var _nikolakasev$hello_elm$Repl$d_e_l_t_r_o_n_3_0_3_0 = A2(_elm_lang$core$Result$map, _nikolakasev$hello_elm$Model$encodeList, _nikolakasev$hello_elm$Model$testProcessWithIngredients);
